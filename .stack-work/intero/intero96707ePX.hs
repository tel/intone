...
data B1 = B1_1 deriving (Eq, Ord, Show, Enum)

instance Enumerable B1 where
  enumeration = [B1_1]

-- | Anonymous 2-dimensional basis
data B2 = B2_1 | B2_2 deriving (Eq, Ord, Show, Enum)

instance Enumerable B2 where
  enumeration = [B2_1, B2_2]

-- | Anonymous 3-dimensional basis
data B3 = B3_1 | B3_2 | B3_3 deriving (Eq, Ord, Show, Enum)

instance Enumerable B3 where
  enumeration = [B3_1, B3_2, B3_3]
